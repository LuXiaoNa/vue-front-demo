...
import arrayEqual from "@/utils/scroll/arrayEqual.js";
//   const copyObj = require('comutils/copyObj')
import copyObj from "@/utils/scroll/copyObj.js";
export default {
    ...
    _move() {
      ...
      this.reqFrame = requestAnimationFrame(
        function() {
          ...
          if (this.realSingleStopHeight==false) {
            //是否启动了单行暂停配置
          ...
          } else if (this.realSingleStopWidth==false) {
